<template>
  <div class="container">
    <!--    <div class="title mb-3" style="cursor: pointer; background: #5cb85c" @click="$router.push('/ao')"> {{ $t("message.List of AO by year") }}<el-icon size="22" style="margin-left: 4px"><Right /></el-icon> </div>-->
    <!--    <div class="title mb-3" style="cursor: pointer; background: #5cb85c" @click="$router.push('/random')"> {{ $t("message.roulette") }} <el-icon size="22" style="margin-left: 4px"><Right /></el-icon></div>-->
