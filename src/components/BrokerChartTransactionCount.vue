      ...
      tooltip: {
        ...
        formatter: function (params) {
          ...
          params.forEach((item) => {
            ...
            result += `${item.marker}${item.seriesName}: ${item.data.value.toLocaleString()} <br> Transaction Amount: ${item.data.count.toLocaleString()}<br/>`
          })
          return result
        },
      },
      ...
      series: [
        {
          ...
          data: props.chartData.map((item) => ({
            ...
            count: item.transactions_amount, // Assuming this additional data point
          })),
          type: 'bar',
